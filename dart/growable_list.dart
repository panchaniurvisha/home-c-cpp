void main(){
  ...
  List<int>listSeventeen =[1,2,3,4,5];///value maintain 
  int number=listSeventeen.fold<int>(10, (previousValue, element) =>  previousValue + element);
  print("\n Sum :$number");

  List <String> listEighteen =["vaidehi","urvi","piyu"];///followed next String
  print(listEighteen);
  print(listEighteen.followedBy(["tom"]));

  List<String> listNinteen =['Flutter Cookbook', 'Dart NoteBook', 'educative.io','Dart language'];///in string show where is its index no
  print(listNinteen);
  int foundIndex =listNinteen.indexWhere((listNinteen) => listNinteen.endsWith("k"));
   print('Index: $foundIndex');
  int found =listNinteen.indexWhere((listNinteen) => listNinteen.startsWith("D"));
   print('Index: $found');
  int foundSecond =listNinteen.indexWhere((listNinteen) => listNinteen.startsWith("D"),2);
  ...
  print(listTwentyThree.lastIndexWhere((element) => element.startsWith('p'),2));
